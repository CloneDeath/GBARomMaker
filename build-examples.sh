...
dotnet "GBARomMaker/bin/Debug/net10.0/GBARomMaker.dll" "Examples/06-ConsoleWrite/bin/Debug/net10.0/ConsoleWrite.dll" "Examples/06-ConsoleWrite.gba" --show-cil --show-arm
